...
const BREED_MAP = {
  ...
  'quarter horse':         { type: 'other', query: 'quarter horse' },
  ...
  'cavalo mustang':        { type: 'other', query: 'mustang wild horse' },
  'andaluz':               { type: 'other', query: 'andalusian horse' },
  'cavalo andaluz':        { type: 'other', query: 'andalusian horse' },
  'mangalarga marchador':  { type: 'other', query: 'mangalarga marchador horse brazil' },
  'mangalarga':            { type: 'other', query: 'mangalarga marchador horse' },
  ...
  'pônei':                 { type: 'other', query: 'pony horse small' },
